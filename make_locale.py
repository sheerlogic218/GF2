...
TRANSLATIONS_FR = {
    ...
    (
        ...
        "   - Utilisez la zone de saisie pour ajuster le nombre de cycles.\n"
        "   - Cliquez sur '▶' pour démarrer ou redémarrer la simulation depuis zéro.\n"
        "   - Cliquez sur '+N' pour continuer l'exécution sur d'autres cycles.\n"
        ...
        "   - Faites défiler la Molette pour zoomer en douceur.\n"
        "   - Clic droit dans le canevas pour copier ou enregistrer une image.\n\n"
        "3. Commutateurs et moniteurs :\n"
        "   - Sélectionnez un commutateur et basculez son état avec 'Activer' / 'Désactiver'.\n"
